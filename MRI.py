...
main = tkinter.Tk()
main.title("Machine learning apprach for brain tumor detection") #designing main screen
...
def predict():
    ...
    ftp.login("reddychandru15@gmail.com", "Chandra@789")
    ftp.prot_p()
    name = imagelist.get()
...
font = ('times', 16, 'bold')
title = Label(main, text='Machine learning approach for brain tumor detection')
...
cnnButton = Button(main, text="Generate machine Learning-CNN Model", command=CNN)
